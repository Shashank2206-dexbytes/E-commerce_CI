                ...
                <div class="card">
                    ...
                    <form method="post" action="" id="validations">
                        ...
                        <div class="form-row">
                            ...
                            <input type="text" class="form-control"  value=<?php echo $edit['name'] ?>  placeholder="Name" name="category_name">
                            ...
                            <select id="inputState" class="form-control" name="parent_category">
                                <?php foreach ($category as $row) : ?>
                                    <option value="<?php echo $row['id']; ?>" <?php echo ($row['id'] == $edit['parent_category']) ? 'selected' : ''; ?>><?php echo $row['name']; ?></option>
                                <?php endforeach; ?>
                                <option value="0">No Parent Categories</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control h-150px" rows="6" id="comment" name="category_description"><?php echo addslashes($edit['description']) ?></textarea>
                        ...
                        <div class="input-group mb-3" id="selectimage">
                            ...
                            <img src="/Ecommerce_ci/Assets/images/member/<?php echo $edit['image'] ?>" alt="member" id="bulk" height="50px" width="">
                            </div>
